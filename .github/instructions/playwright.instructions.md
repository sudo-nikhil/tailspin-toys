...
- **Comment Philosophy**: Write comments to explain why a test exists or why a flaky scenario is structured a certain way. Do not add comments that simply restate what the code does or duplicate the step name.
